  ...
  <div class="tree">
    <ul class="node-tree">
      <li
        ...
        :key="rule.route">
        <Button v-if="rule.children" type="text" @click="openChild(parentIndex)" style="position:absolute;top: -9px;left: -50px;width:40px;height: 40px;" :style="{transform : rule.openList ? 'rotateZ(90deg)' : 'rotateZ(0deg)'}">
